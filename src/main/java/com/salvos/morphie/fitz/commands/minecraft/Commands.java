...
public class Commands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("verify")) {
            ...
            if (args.length == 0) {
                sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&8---------- [&9&lDiscord&8] ----------"));
                sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&b/discord unlink &7- &aUnlink your discord and minecraft accounts."));
                sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&b/verify <code> &7- &aUse the Code Fitz sends you on discord from the !link <mc name>."));
                sender.sendMessage("");
